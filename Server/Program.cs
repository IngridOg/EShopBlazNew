...
else
{
    ...
    app.UseHsts();
    var eShopBasePath = new EShopBasePath();
    builder.Configuration.GetSection(nameof(EShopBasePath)).Bind(eShopBasePath);
    app.UsePathBase(eShopBasePath.Configuration);
}
